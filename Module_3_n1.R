...
Data.table <- read.csv("D:/Bioinformatics_Seminar_2022/Bioinformatics.csv")
...
#the output of lapply(). This will try to output a simple array 
#rather than a list. 
x <- sample(1:100, size = 10)
y <- sample(1:100, size = 10)
z <-  sample(1:100, size = 10)
...
geneIDs=read.csv("D:/Bioinformatics_Seminar_2022/gene_id_to_symbol.csv")
